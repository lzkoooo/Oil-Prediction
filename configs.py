...
class Config:
    def __init__(self, mem_days=5, pre_days=2, num_epoch=50, batch_size=32, is_shuffle=True, num_layers=2, hidden_size=32, learn_rate=0.005, dropout=0.3, step_size=1, gamma=0.99):
